...
namespace CUFramework.Dialogs
{
    public class CUMessageBox
    {
        ...
        class MsgBox : CUWindow
        {
            ...
            {
                Button btnAbort = new CUButton();
                btnAbort.Text = "INTERRUPT";
                btnAbort.Click += ButtonClick;

                Button btnRetry = new CUButton();
                btnRetry.Text = "RETRY";
                btnRetry.Click += ButtonClick;

                Button btnIgnore = new CUButton();
            ...
            {
                Button btnYes = new CUButton();
                btnYes.Text = "YES";
                btnYes.Click += ButtonClick;

                Button btnNo = new CUButton();
                btnNo.Text = "NO";
